...
.moveAhead2
	...
	call DoBikeSpeedup
	jr .notRunning
.normalPlayerSpriteAdvancement		; surf at 2x walking speed
	ld a, [wWalkBikeSurfState]
	cp $02
	jr z, .surfFaster	; Holding B makes you run at 2x walking speed
	ld a, [hJoyHeld]
	and B_BUTTON
	jr z, .notRunning
.surfFaster
	call DoBikeSpeedup
.notRunning		;original .normalPlayerSpriteAdvancement continues here
